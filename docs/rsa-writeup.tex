...
\subsection{Bitmap}
\subsection{Runtime Analysis}
Our implementation is very slow. The slowness either comes from Miller-Rabin or RNG of stupid big integers, but we're not sure which one exactly. This concludes our runtime analysis.
